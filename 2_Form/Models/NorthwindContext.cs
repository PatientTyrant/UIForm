...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<KategoriveUrunleri> KategoriveUrunleris { get; set; }
    ...
    public virtual DbSet<ShipperView> ShipperViews { get; set; }

    public virtual DbSet<ShippersLog> ShippersLogs { get; set; }
    ...
    public virtual DbSet<UrunStokDurumu> UrunStokDurumus { get; set; }

    public virtual DbSet<Urunler> Urunlers { get; set; }

    protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)

        => optionsBuilder.UseSqlServer("SERVER=DESKTOP-7GBAU63; Database=Northwind; uid=berat;pwd=12345678; TrustServerCertificate=true;");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.ToTable(tb => tb.HasTrigger("InsertTrigger"));
        ...
        {
            entity.HasKey(e => e.ProductId).HasName("pk_CategoryProduct");
            ...
            entity.HasOne(d => d.Category).WithMany(p => p.CategoryProducts)
                ...
                .HasConstraintName("fk_CategoryProductCategory");
        });
        ...
        modelBuilder.Entity<KategoriveUrunleri>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("KategoriveUrunleri");
        ...
        modelBuilder.Entity<Kullanicilar>(entity =>
        {
            ...
            entity.HasIndex(e => e.Email, "IX_Kullanicilar").IsUnique();
            ...
            entity.Property(e => e.Maas).HasColumnType("decimal(5, 2)");
            entity.Property(e => e.MemleketId).HasMaxLength(20);
            entity.Property(e => e.SoyAdi).HasMaxLength(50);

            entity.HasOne(d => d.Memleket).WithMany(p => p.Kullanicilars)
                .HasForeignKey(d => d.MemleketId)
                .HasConstraintName("FK_Kullanicilar_Territories");
        });
        ...
        modelBuilder.Entity<Region>(entity =>
        {
            ...
            entity.ToTable("Region", tb => tb.HasTrigger("spDel"));
        ...
        modelBuilder.Entity<ShipperView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ShipperView");
        ...
        modelBuilder.Entity<ShippersLog>(entity =>
        {
            entity
                .HasNoKey()
                .ToTable("ShippersLog");
        ...
        modelBuilder.Entity<Tedarikciler>(entity =>
        {
            ...
            entity.HasIndex(e => e.CompanyName, "NonClusteredIndex-20221213-215429").IsUnique();
        ...
        modelBuilder.Entity<UrunStokDurumu>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("UrunStokDurumu");
